...
<section class="bg-blue-100 w-10/12 p-20 lg:py-[120px] overflow-hidden relative z-10">
   <div class="container">
      <div class="flex flex-wrap lg:justify-between -mx-4">
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[570px] mb-12 lg:mb-0">
               <span class="block mb-4 text-base text-blue-700 text-primary font-semibold">
               İletişime Geç
               </span>
               <h2
                  class="
               ...
               <p class="text-base text-body-color text-blue-600 leading-relaxed mb-9">
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-blue-600 text-xl mb-1">Konumumuz</h4>
                     <p class="text-base text-body-color text-blue-600">
                        Esenetepe Mahallesi Duru Sokak No : 4
                     </p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-blue-600 text-xl mb-1">Telefon Numarası</h4>
                     <p class="text-base text-blue-600 text-body-color">(+90) 552 480 61 53</p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-blue-600 text-xl mb-1">
                        Email Addresimiz
                     </h4>
                     <p class="text-base text-blue-600 text-body-color">melih@education.com</p>
                  </div>
               </div>
            </div>
         </div>
