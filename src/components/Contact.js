...
const Contact = () => {
   ...
   return (
      <div className='w-full flex items-center mt-28 justify-center'>

         <section className=" w-full p-24 overflow-auto relative z-10">
                  ...
                  "
                     ...
                     "
                           ...
                           <div className="w-full">
                              <h4 className="font-bold text-blue-500 text-xl mb-1">Konumumuz</h4>
                              <p className="text-base text-body-color text-blue-500">
                     ...
                     "
                           ...
                           <div className="w-full">
                              <h4 className="font-bold text-blue-500 text-xl mb-1">Telefon Numarası</h4>
                              <p className="text-base text-blue-500 text-body-color">(+90) 552 480 61 53</p>
                           </div>
                        </div>
                        <div className="flex mb-8 max-w-[370px] w-full">
                           <div
                     ...
                     "
                           ...
                           <div className="w-full">
                              <h4 className="font-bold text-blue-500 text-xl mb-1">
                                 Email Addresimiz
                              </h4>
                              <p className="text-base text-blue-500 text-body-color">melih@education.com</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
                     <div className="bg-blue-100  relative rounded-lg p-8 sm:p-12 shadow-lg">
                        <form>
                           <div className="mb-6">
                              <input
                                 type="text"
